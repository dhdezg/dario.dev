...
function Header() {
  ...
  return (
  <header id='header-wrapper' className='dark:bg-slate-950 bg-slate-200 text-slate-950 dark:text-slate-200'>
    <div className='flex flex-row justify-between p-6 items-center'>
      ...
      <div id='menu' className='font-urbanist flex gap-3'>
        ...
        {isDropdownOpen && (
            <div className='absolute top-12 right-2 mt-2 w-40 bg-white dark:bg-slate-800 shadow-lg rounded-lg p-4'>
